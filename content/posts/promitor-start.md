...
description: Promitor is actually pretty medicore.
author: Archiel
...
#### Subtitle: Promitor is actually medicore.
{{< /center >}}
...
Promitor features an amazing fertility of 112%. So with the COGC and 5 experts, your farms will operate at almost 180%. Surely this means you'll make fanastic money on Promitor, right? Let's take a look at a farm focused base:
...
So it's 31k/d on Harmonia vs 37k/d on Promitor. 20% better is nothing to sneeze at, but less than 40k per day for a permit also isn't amazing. But if you decide you want FRM products in Antares space, Harmonia is a fine option. Keep in mind that people often forgo a 25% COGC bonus, and when mixing experts, they can lose out on up to 60% efficency bonus. So 20% isn't that big a deal.
...
This is a common trap for new players. You don't need to make everything yourself. Especially win cases when the prerequisite materials are easy to come by on the CX, it can be more profitable to buy them than try to make them yourself. For specialty items, certain inputs may not be consistently available, but that's not what you should be focusing on as a new player.
...
That's fine, but I encourage you to think of 
